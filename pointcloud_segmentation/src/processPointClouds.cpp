...
#include "pointcloud_segmentation/processPointClouds.hpp"
...
pcl::PCLPointCloud2::Ptr ProcessPointClouds::FilterCloud(
  ...
  Eigen::Vector4f                       maxPoint)
{
  ...
  pcl::PCLPointCloud2::Ptr cloudRegion (new pcl::PCLPointCloud2);
...
std::pair<pcl::PCLPointCloud2::Ptr,
          pcl::PCLPointCloud2::Ptr> ProcessPointClouds::SeparateClouds(
  pcl::PointIndices::Ptr                inliers,
  pcl::PCLPointCloud2::Ptr cloud)
{
  // Create two new point clouds, one cloud with obstacles and other with segmented plane
  pcl::PCLPointCloud2::Ptr obstCloud {new pcl::PCLPointCloud2()};
  pcl::PCLPointCloud2::Ptr planeCloud {new pcl::PCLPointCloud2()};
  ...
  std::pair<pcl::PCLPointCloud2::Ptr,
            pcl::PCLPointCloud2::Ptr> segResult(obstCloud, planeCloud);
